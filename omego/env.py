...
class EnvDefault(argparse.Action):
    ...
    See: http://stackoverflow.com/questions/10551117/setting-options-from-environment-variables-when-using-argparse

    Note: required set to False rather than True to handle empty string defaults.
